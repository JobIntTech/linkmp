...
def bakeAndPublishChart(String applicationVersion, String repoName) {
    ...
    sh "helm package . --app-version ${applicationVersion} --version ${chartVersion}-${applicationVersion}"
    sh "helm cm-push --force ${chartName}-${chartVersion}-${applicationVersion}.tgz ${repoName}"
